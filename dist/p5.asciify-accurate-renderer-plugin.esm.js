...
var p = (e, r, t) => r in e ? m(e, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[r] = t;
var i = (e, r, t) => p(e, typeof r != "symbol" ? r + "" : r, t);
import { renderers as o } from "p5.asciify";
const u = (e) => `
...
\r
  ...
  if (typeof o < "u" && o.renderer2d && o.renderer2d.feature && typeof o.renderer2d.feature.P5AsciifyAbstractFeatureRenderer2D < "u")
    return o.renderer2d.feature.P5AsciifyAbstractFeatureRenderer2D;
...
class C extends v() {
  ...
  constructor(t, s, n, _, g = l) {
    ...
    this._characterSelectionShader = this._p.createShader(a, u(this._fontManager.fontSize)), this._brightnessSampleShader = this._p.createShader(a, f(this._grid.cellHeight, this._grid.cellWidth)), this._colorSampleShader = this._p.createShader(a, c(16, this._grid.cellHeight, this._grid.cellWidth)), this._brightnessSplitShader = this._p.createShader(a, S), this._brightnessSampleFramebuffer = this._p.createFramebuffer({
      density: 1,
  ...
  resetShaders() {
    this._characterSelectionShader = this._p.createShader(a, u(this._fontManager.fontSize)), this._brightnessSampleShader = this._p.createShader(a, f(this._grid.cellHeight, this._grid.cellWidth)), this._colorSampleShader = this._p.createShader(a, c(16, this._grid.cellHeight, this._grid.cellWidth));
  }
  render() {
...
typeof window < "u" && (window.AccurateRendererPlugin = F);
export {
  F as AccurateRendererPlugin
};
